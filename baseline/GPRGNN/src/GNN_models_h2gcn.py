...
class GPRGNN(torch.nn.Module):
    def __init__(self, dataset, args):
        ...
        # self.lin1 = Linear(dataset.feature_dim, args.hidden)
        # self.lin2 = Linear(args.hidden, dataset.num_labels)
        self.lin1 = Linear(2, args.hidden)
        self.lin2 = Linear(args.hidden, 8)
