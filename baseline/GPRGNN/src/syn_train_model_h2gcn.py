...
def RunExp(args, dataset, Net, percls_trn, val_lb):
    ...
    train_mask, val_mask, test_mask = permute_masks(dataset, dataset.num_labels, percls_trn, val_lb)
    ...
    for name in data_list:
        ...
        for RP in tqdm(range(RPMAX)):
            test_acc, best_val_acc, Gamma_0 = RunExp(
                args, dataset, Net, percls_trn, val_lb)
